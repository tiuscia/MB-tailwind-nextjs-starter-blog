...
const Accordion = () => {
  ...
  return (
    ...
    <div id="accordion-open" data-accordion="open">
        ...
        <button 
            type="button" 
            className="font-albert text-2xl md:text-4xl font-semibold flex items-center justify-between w-full p-5 lg:py-7 lg:pr-8 rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" 
        ...
        <div id="accordion-open-body-1" className={openIndex === 0 ? '' : 'hidden'} aria-labelledby="accordion-open-heading-1">
            <div className="p-5 border border-b-0 lg:px-6 lg:py-8  border-gray-200 dark:border-gray-700 dark:bg-gray-900">
        ...
        <button 
            type="button" 
            className="font-albert text-2xl text-left md:text-4xl font-semibold flex items-center justify-between w-full p-5 lg:py-7 lg:pr-8 rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" 
        ...
        <div id="accordion-open-body-2" className={openIndex === 1 ? '' : 'hidden'} aria-labelledby="accordion-open-heading-2">
            <div className="p-5 border border-b-0 lg:px-6 lg:py-8 border-gray-200 dark:border-gray-700">
        ...
        <button 
            type="button" 
            className="font-albert text-2xl text-left md:text-4xl font-semibold flex items-center justify-between w-full p-5 lg:py-7 lg:pr-8 rtl:text-right text-gray-500 border border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" 
